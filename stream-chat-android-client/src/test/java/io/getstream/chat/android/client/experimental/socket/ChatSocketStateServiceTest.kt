...
internal class ChatSocketStateServiceTest {
    ...
    fun `When NetworkNotAvailable event arrives, should move to the proper state`(initialState: State, resultState: State) {
        val sut = ChatSocketStateService(initialState)
    ...
    fun `When RequiredDisconnect event arrives, should move to the proper state`(initialState: State, resultState: State) {
        val sut = ChatSocketStateService(initialState)
    ...
    fun `When Stop event arrives, should move to the proper state`(initialState: State, resultState: State) {
        val sut = ChatSocketStateService(initialState)
    ...
    fun `When WebSocket event lost arrives, should move to the proper state`(initialState: State, resultState: State) {
        val sut = ChatSocketStateService(initialState)
