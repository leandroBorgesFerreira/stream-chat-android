...
import io.getstream.chat.android.client.experimental.socket.ChatSocketStateService.State
...
internal class ChatSocket private constructor(
    ...
    private val lifecycleHandler = object : LifecycleHandler {
        override fun resume() { connectionConf?.let { chatSocketStateService.onReconnect(it) } }
        override fun stopped() { chatSocketStateService.onStop() }
    }
    private val networkStateListener = object : NetworkStateProvider.NetworkStateListener {
        override fun onConnected() { connectionConf?.let { chatSocketStateService.onReconnect(it) } }
